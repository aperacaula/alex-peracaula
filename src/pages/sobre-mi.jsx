...
const SecondPage = (props) => (
  <Layout page={'sobremi'} >
    ...
    <p>Me llamo Àlex Peracaula Ruiz, y nací el 7 de octubre de 1993 en Barcelona,
     donde actualmente resido. Mi pasión por la interpretación nació muy temprano.
     ...
     <p>Manteniendo el teatro como un hobbie, aunque necesario, estudié Ingeniería Industrial
       ...
       donde pude juntar diariamente mis estudios con mi pasión por el surf. Tras volver a Europa,
       ...
       "Much Ado About Nothing" de William Shakespeare, pude trabajar con dialectos ingleses
       y aplicar el conocimiento profesional que tenía hasta entonces del idioma encima de 
     ...
     <p>Por ello, volví a Barcelona en 2017, donde cursé la Formación Profesional 
       ...
       tanto sobre mis mecanismos emocionales como actor, como sobre las técnicas
       necesarias en la interpretación. Mis ganas y voluntad de actuar me han llevado a complementar
       ...
       complementarios y, en definitiva, preocuparse por crecer como artista día a día.
       </p>
