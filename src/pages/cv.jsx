...
const CV = (props) => (
  <Layout page={'cv'}>
    ...
    <div className={styles.cv_container}>
      ...
      <ul>
        <li>
          2025, <strong>"The Last Sunrise"</strong>, Largometraje, Carlos, dir. Carlson Young, Amazon MGM
        </li>
        <li>
          2025, <strong>"Nuda Propiedad"</strong>, Largometraje, Reparto, dir. Alberto Utrera, Garajonay Prod.
        </li>
        <li>
