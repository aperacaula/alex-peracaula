...
const Galeria = (props) => {
  ...
  return (
    <Layout page={'galeria'} lan='ca'>
      <SEO title="Galeria" lang="ca" description="Photobook d'Alex Peracaula. Aquesta pàgina serveix com a book fotogràfic i ensenya fotografies de diferents sessions on he participat."/>
